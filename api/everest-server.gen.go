...
type ServerInterface interface {
	...
	// Get metrics for a database cluster
	// (GET /namespaces/{namespace}/database-clusters/{name}/monitoring/metrics)
	GetDatabaseClusterMetrics(ctx echo.Context, namespace string, name string, params GetDatabaseClusterMetricsParams) error
...
// GetDatabaseClusterMetrics converts echo context to params.
func (w *ServerInterfaceWrapper) GetDatabaseClusterMetrics(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "namespace" -------------
	var namespace string
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetDatabaseClusterMetricsParams
	// ------------- Required query parameter "query" -------------

	err = runtime.BindQueryParameterWithOptions("form", true, true, "query", ctx.QueryParams(), &params.Query, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, true, "start", ctx.QueryParams(), &params.Start, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, true, "step", ctx.QueryParams(), &params.Step, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter step: %s", err))
	}

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetDatabaseClusterMetrics(ctx, namespace, name, params)
	return err
}
...
func RegisterHandlersWithOptions(router EchoRouter, si ServerInterface, options RegisterHandlersOptions) {
	...
	router.GET(options.BaseURL+"/namespaces/:namespace/database-clusters/:name/monitoring/metrics", wrapper.GetDatabaseClusterMetrics, options.OperationMiddlewares["getDatabaseClusterMetrics"]...)
