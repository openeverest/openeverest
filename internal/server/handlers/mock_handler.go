...
// CreateMonitoringConfig provides a mock function with given fields: ctx, req
func (_m *MockHandler) CreateMonitoringConfig(ctx context.Context, req *api.MonitoringConfigCreateParams) (*monitoringv1alpha1.MonitoringConfig, error) {
	ret := _m.Called(ctx, req)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.MonitoringConfigCreateParams) (*monitoringv1alpha1.MonitoringConfig, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *api.MonitoringConfigCreateParams) *monitoringv1alpha1.MonitoringConfig); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *api.MonitoringConfigCreateParams) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
