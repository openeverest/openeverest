...
func (h *validateHandler) ListProviders(ctx context.Context) (*v2alpha1.ProviderList, error) {
	return h.next.ListProviders(ctx)
}

// GetProvider proxies the request to the next handler.
func (h *validateHandler) GetProvider(ctx context.Context, name string) (*v2alpha1.Provider, error) {
