...
func (h *validateHandler) ListMonitoringConfigs(ctx context.Context, cluster, namespace string) (*monitoringv1alpha1.MonitoringConfigList, error) {
	return h.next.ListMonitoringConfigs(ctx, cluster, namespace)
}

// CreateMonitoringConfig proxies the request to the next handler.
func (h *validateHandler) CreateMonitoringConfig(ctx context.Context, cluster, namespace string, req *api.MonitoringConfigCreateParams) (*monitoringv1alpha1.MonitoringConfig, error) {
...
func (h *validateHandler) GetMonitoringConfig(ctx context.Context, cluster, namespace, name string) (*monitoringv1alpha1.MonitoringConfig, error) {
...
func (h *validateHandler) UpdateMonitoringConfig(ctx context.Context, cluster, namespace, name string, req *api.MonitoringConfigUpdateParams) (*monitoringv1alpha1.MonitoringConfig, error) {
	if req.Url != "" {
