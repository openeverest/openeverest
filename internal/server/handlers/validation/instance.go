...
func (h *validateHandler) ListInstances(ctx context.Context, namespace string) (*v2alpha1.InstanceList, error) {
	return h.next.ListInstances(ctx, namespace)
}

// GetInstance proxies the request to the next handler.
func (h *validateHandler) GetInstance(ctx context.Context, namespace, name string) (*v2alpha1.Instance, error) {
	return h.next.GetInstance(ctx, namespace, name)
}

// CreateInstance proxies the request to the next handler.
func (h *validateHandler) CreateInstance(ctx context.Context, instance *v2alpha1.Instance) (*v2alpha1.Instance, error) {
...
func (h *validateHandler) UpdateInstance(ctx context.Context, instance *v2alpha1.Instance) (*v2alpha1.Instance, error) {
	// Add validation here if needed in the future
