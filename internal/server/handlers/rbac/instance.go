...
func (h *rbacHandler) ListInstances(ctx context.Context, namespace string) (*v2alpha1.InstanceList, error) {
...
func (h *rbacHandler) GetInstance(ctx context.Context, namespace, name string) (*v2alpha1.Instance, error) {
	// Add RBAC checks here if needed in the future
	return h.next.GetInstance(ctx, namespace, name)
}

// CreateInstance proxies the request to the next handler.
func (h *rbacHandler) CreateInstance(ctx context.Context, instance *v2alpha1.Instance) (*v2alpha1.Instance, error) {
	// Add RBAC checks here if needed in the future
	return h.next.CreateInstance(ctx, instance)
}

// UpdateInstance proxies the request to the next handler.
func (h *rbacHandler) UpdateInstance(ctx context.Context, instance *v2alpha1.Instance) (*v2alpha1.Instance, error) {
	// Add RBAC checks here if needed in the future
