...
func (h *rbacHandler) ListProviders(ctx context.Context) (*v2alpha1.ProviderList, error) {
...
func (h *rbacHandler) GetProvider(ctx context.Context, name string) (*v2alpha1.Provider, error) {
	// Add RBAC checks here if needed in the future
