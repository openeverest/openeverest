...
type ClientInterface interface {
	...
	GetUserAccount(ctx context.Context, username string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SetUserPasswordWithBody request with any body
	SetUserPasswordWithBody(ctx context.Context, username string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SetUserPassword(ctx context.Context, username string, body SetUserPasswordJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetUserAccount(ctx context.Context, username string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetUserAccountRequest(c.Server, username)
	if err != nil {
		return nil, err
	}
...
func (c *Client) SetUserPasswordWithBody(ctx context.Context, username string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SetUserPassword(ctx context.Context, username string, body SetUserPasswordJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewGetUserAccountRequest(server string, username string) (*http.Request, error) {
	var err error
...
func NewSetUserPasswordRequest(server string, username string, body SetUserPasswordJSONRequestBody) (*http.Request, error) {
...
func NewSetUserPasswordRequestWithBody(server string, username string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/accounts/%s/password", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	// GetUserAccountWithResponse request
	GetUserAccountWithResponse(ctx context.Context, username string, reqEditors ...RequestEditorFn) (*GetUserAccountResponse, error)

	// SetUserPasswordWithBodyWithResponse request with any body
	SetUserPasswordWithBodyWithResponse(ctx context.Context, username string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SetUserPasswordResponse, error)

	SetUserPasswordWithResponse(ctx context.Context, username string, body SetUserPasswordJSONRequestBody, reqEditors ...RequestEditorFn) (*SetUserPasswordResponse, error)
...
func (c *ClientWithResponses) GetUserAccountWithResponse(ctx context.Context, username string, reqEditors ...RequestEditorFn) (*GetUserAccountResponse, error) {
	rsp, err := c.GetUserAccount(ctx, username, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SetUserPasswordWithBodyWithResponse(ctx context.Context, username string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SetUserPasswordResponse, error) {
...
func (c *ClientWithResponses) SetUserPasswordWithResponse(ctx context.Context, username string, body SetUserPasswordJSONRequestBody, reqEditors ...RequestEditorFn) (*SetUserPasswordResponse, error) {
