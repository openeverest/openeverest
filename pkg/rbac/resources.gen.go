...
var resourcePathMap = map[string]string{
	...
	"/clusters/:cluster/namespaces/:namespace/config-maps": "config-maps",
	"/clusters/:cluster/namespaces/:namespace/config-maps/:name": "config-maps",
	...
	"/clusters/:cluster/namespaces/:namespace/instances/:instance/draft-preset": "instance-presets",
