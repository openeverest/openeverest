...
func (k *Kubernetes) ListPlugins(ctx context.Context, opts ...ctrlclient.ListOption) (*v1alpha1.PluginList, error) {
...
func (k *Kubernetes) GetPlugin(ctx context.Context, key ctrlclient.ObjectKey) (*v1alpha1.Plugin, error) {
