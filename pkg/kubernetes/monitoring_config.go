...
func (k *Kubernetes) ListMonitoringConfigs(ctx context.Context, opts ...ctrlclient.ListOption) (*everestv1alpha1.MonitoringConfigList, error) {
	...
	err := listPaginated(ctx, k.k8sClient, result,
		func() *everestv1alpha1.MonitoringConfigList { return &everestv1alpha1.MonitoringConfigList{} },
		func(res, page *everestv1alpha1.MonitoringConfigList) { res.Items = append(res.Items, page.Items...) },
		opts...,
	)
	if err != nil {
		return nil, err
